    ...
    <el-col :xs="24" :sm="22" :lg="14">
      <el-card>
        ...
        <el-form :model="form" :rules="rules" ref="form">
          ...
          <el-form-item label="抵押net数量 " prop="stake_net_quantity">
            <el-input v-model="form.stake_net_quantity" placeholder="例: 1.0000 或 0.0000 ">
                <template slot="append">EOS</template>
            </el-input>
          </el-form-item>
          <el-form-item label="抵押cpu数量" prop="stake_cpu_quantity">
            <el-input v-model="form.stake_cpu_quantity" placeholder="例: 1.0000 或 0.0000">
                <template slot="append">EOS</template>
            </el-input>
          </el-form-item>
          <el-form-item label="是否将对应通证转账给接受者">
             <el-radio-group v-model="form.transfer" :disabled="form.self">
                <el-radio :label="true">是</el-radio>
                <el-radio  :label="false">否</el-radio>
              </el-radio-group>
            <span>( 这一项设置为 '是' 时，抵押会转给账户账号 )</span>
          </el-form-item>
          <el-form-item>
     ...
     <el-col :xs="24" :sm="22" :lg="8" class="aside-spaceing">
      <el-card style="color: #909399;">
        ...
        <ol>
          ...
          <li>代币数量需保留四位小数，若为 0.0000 表示不抵押该项资源</li>
        </ol>
      </el-card>
    </el-col>
